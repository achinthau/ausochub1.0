<div wire:init="refreshTimeline">
    ...
    @php
        ...
        $hideNotAnsweredButtons = ($ticket->status == 'ReOpened') || ($ticket->status == 'Canceled') || ($ticket->status == 'Skip' && $lastUpdated->greaterThan(\Carbon\Carbon::now()->subMinutes(0.5)));
    ...
    ">
        ...
        <div class="text-sm mt-4">
            ...
            <div class="flex pt-4 space-x-3 pb-2">
                ...
                <div class="group relative inline-flex">
                    <a href="#"
                       wire:click.prevent="$emitTo('cx-tickets.survey.rating-panel','showCxTicketRatingModal', {{ $ticket->id }}, true, '{{ $feedContactId }}')"
                ...
                <div class="group relative inline-flex">
                    <a href="#"
                       wire:click.prevent="$emitTo('cx-tickets.survey.reopen-panel','showReOpenPanel', {{ $ticket->id }}, 'reopen', '{{ $feedContactId }}')"
                ...
                {{-- Not Answered --}}
                    ...
                    <button type="button"
                        wire:click="$emit('openCallStatusModal', '{{ $feedContactId }}', 'not_answered', {{$surveyContacts->count()}}, {{ $ticket->id }})"
