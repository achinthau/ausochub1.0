            ...
            <canvas
                x-data="{
                    ...
                    initChart: function (data = null) {
                        ...
                        let options = {{ json_encode($this->getOptions()) }} ?? {};
                        
                        // Custom Tooltip Override for TechnicianRatingChart
                        // Ensure nested objects exist
                        options.plugins = options.plugins || {};
                        options.plugins.tooltip = options.plugins.tooltip || {};
                        options.plugins.tooltip.callbacks = options.plugins.tooltip.callbacks || {};
                        
                        // Override the label callback to show only the label (which includes percentage)
