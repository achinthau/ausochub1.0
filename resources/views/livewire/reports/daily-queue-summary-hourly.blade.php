    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-4">
                <a href="{{ route('reports.daily-queue-summary-report') }}" class="text-gray-500 hover:text-gray-700 transition">
            ...
            <x-button
                href="{{ route('reports.daily-queue-summary-hourly-analytics', ['date' => $date, 'queue' => $queue]) }}"
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach($hourlyData as $row)
                                <tr class="hover:bg-gray-50 transition">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $row['agents'] }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
