    ...
    @endif
                            ...
                            @if (($timelineLog['kind'] ?? null) === 'call' && !empty($timelineLog['ticket_count']))
                                <button type="button"
                                    ...
                                    <svg class="h-4 w-4 {{ $timelineLog['latest_ticket_status_id'] == 4 ? 'text-red-600' : ($timelineLog['latest_ticket_status_id'] == 3 ? 'text-orange-900' : ($timelineLog['latest_ticket_status_id'] == 2 ? 'text-green-600' : ($timelineLog['latest_ticket_status_id'] == 5 ? 'text-yellow-600' : 'text-blue-500'))) }}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
