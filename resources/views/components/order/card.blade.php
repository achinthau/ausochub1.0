<div
    ...
    <div class="grid grid-cols-2 text-gray-500 h-4">
        @if ($ticket->lead)
            <div class="flex space-x-1">
                <svg fill="currentColor" class="w-4 h-4" version="1.1" xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 32 32">
    ...
    <div class="grid grid-cols-3">
        <div class="flex text-xs items-center gap-1 font-semibold text-gray-500 cursor-pointer hover:text-indigo-500"
            onclick="Livewire.emitTo('orders.show', 'openTicket',{{ $ticket->id }})">
        ...
        {{-- <div class="flex text-xs items-center gap-1 font-semibold text-gray-300 cursor-pointer hover:text-indigo-500">
            <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" fill="currentColor">
                <path
        ...
        <div class="flex text-xs items-center gap-1 font-semibold text-gray-300 cursor-pointer hover:text-red-400">
