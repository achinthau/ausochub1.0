<div>
    ...
    <svg class="w-8 h-8 text-blue-400 hover:text-blue-500 cursor-pointer" wire:click="toggleDropdown" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 19 17">
