    ...
    <div class="flex-1 flex flex-col bg-[#efeae2]"> <!-- WhatsApp background color -->
        ...
        @else
            <div class="flex-1 flex flex-col items-center justify-center text-gray-500">
                ...
                <p class="max-w-xs text-center text-gray-500 text-sm leading-relaxed">Select a chat from the sidebar to start messaging. Your messages are end-to-end encrypted.</p>
