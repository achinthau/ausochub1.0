<div>
    ...
    <div class="py-12">
        ...
        <button wire:click="exportManual" class="flex items-center px-3 text-xs font-medium tracking-wider text-green-500 uppercase bg-white border border-green-400 space-x-2 rounded-md leading-4 hover:bg-green-200 focus:outline-none"><span>Export</span>
