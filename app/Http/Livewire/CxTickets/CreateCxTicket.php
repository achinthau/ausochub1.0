...
class CreateCxTicket extends Component
{
    ...
    {
        $this->categories = CxTicketCategory::all(['name']);
        $this->serviceCenters = CxTicketServCenter::all(['name']);
    }
    ...
    public function save()
    {
        ...
        $this->reset(); // Clear form after saving
    }
...
//     $this->dispatchBrowserEvent('openModal', ['modalId' => 'creatingCxTicket']);
// }
