<div class="w-full h-[78vh] overflow-y-auto rounded-lg border border-gray-200 bg-white p-2">
    @foreach ($users as $user)
        <div class="py-1">
            <div class="min-h-[3.25rem] bg-slate-100 hover:bg-gray-200 transition duration-300 flex items-center justify-between rounded-md cursor-pointer px-2"
    ...
    <!-- New User Icon -->
    <svg class="w-full h-full {{ $user->isLoggedIn() ? 'text-blue-400' : 'text-gray-500' }}" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
        <path d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512l388.6 0c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304l-91.4 0z"/>
    </svg>

    <!-- Message Icon -->
    @if (in_array($user->id, $highlightedUserIds))
    <div class="absolute -top-1 -right-2 w-4 h-4">
