...
return new class extends Migration
{
    ...
    public function up()
    {
        DB::connection("mysql-old")->getPdo()->exec('DROP VIEW IF EXISTS today_abandoned_calls;');
        
        DB::connection("mysql-old")->getPdo()->exec("CREATE VIEW today_abandoned_calls
        AS
        ...
        FROM queuecount  qc
        WHERE qc.date BETWEEN TIMESTAMP(CURDATE()) AND NOW()
