...
class DailyQueueSummaryDashboard extends Page
{
    protected static ?string $navigationIcon = 'heroicon-o-document-report';

    protected static string $view = 'filament.pages.daily-queue-summary-dashboard';
    ...
    {
        $queueList = DailyQueueSummary::query()
