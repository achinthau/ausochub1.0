<div wire:init="refreshTimeline">
    ...
    @foreach ($surveyContacts as $ticket)
        @php
            $isSkipped = $ticket->status == "Skip";
        @endphp

        <details class="border-2 border-gray-300 rounded-lg p-4 mb-6 shadow-lg bg-white" >
    ...
    {{-- <div class="group relative inline-flex">
        <a href="#"
           wire:click.prevent="$emitTo('cx-tickets.survey.reopen-panel','showReOpenPanel', {{ $ticket->id }}, 'skip', '{{ $feedContactId }}')"
